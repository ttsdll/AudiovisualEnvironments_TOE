const socket = new WebSocket('wss://nosch.uber.space/web-rooms/');
  ...
  oscillator.frequency.setValueAtTime(400, audioCtx.currentTime); // Frequenz z. B. 400 Hz
  gainNode.gain.setValueAtTime(0.05, audioCtx.currentTime);       // Lautstärke

  oscillator.connect(gainNode).connect(audioCtx.destination);
  oscillator.start();
  oscillator.stop(audioCtx.currentTime + 0.1); // 0.1 Sek. Ton
}
